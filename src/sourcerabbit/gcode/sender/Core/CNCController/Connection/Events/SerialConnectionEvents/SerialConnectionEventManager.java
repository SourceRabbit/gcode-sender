 ...
 */
public class SerialConnectionEventManager extends EventManager
{

    public SerialConnectionEventManager()
    {

    }

    public void FireConnectionEstablishedEvent(SerialConnectionEvent evt)
    {
    ...
    public void FireConnectionClosedEvent(SerialConnectionEvent evt)
    {
        for (Object obj : fEventListeners)
        {
            ISerialConnectionEventListener listener = (ISerialConnectionEventListener) obj;
