...
public class frmGRBLSettings extends JDialog
{
    ...
    private void initComponents()
    {
        ...
        {
            jTableSettings.getColumnModel().getColumn(0).setMinWidth(80);
            jTableSettings.getColumnModel().getColumn(0).setPreferredWidth(80);
            jTableSettings.getColumnModel().getColumn(0).setMaxWidth(80);
            jTableSettings.getColumnModel().getColumn(1).setMinWidth(80);
            jTableSettings.getColumnModel().getColumn(1).setPreferredWidth(80);
            jTableSettings.getColumnModel().getColumn(1).setMaxWidth(80);
        }
