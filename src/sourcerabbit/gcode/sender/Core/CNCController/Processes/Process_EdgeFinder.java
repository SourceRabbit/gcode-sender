 ...
 */
public class Process_EdgeFinder extends Process
{
    ...
    public Process_EdgeFinder(JDialog parentForm)
    {
        super(parentForm);
    }
    ...
    public void Execute()
    {
        ...
        {
            ProbeFailedToTouchTheEdge(ex.getMessage());
        }
    ...
    private void ProbeFailedToTouchTheEdge(String message)
    {
        if (message.equals(""))
        {
